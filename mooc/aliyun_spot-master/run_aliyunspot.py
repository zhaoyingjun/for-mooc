...
class AliyunRunInstancesExample(object):
    ...
    def __init__(self):
        ...
        # 镜像ID
        self.image_id = 'm-0jl5qj0u1gb9gvckobvq'
        # 指定新创建实例所属于的安全组ID
        self.security_group_id = 'sg-0jl200ncwptsdgdh60rt'
        # 购买资源的时长
        self.period = 1
        # 购买资源的时长单位
        ...
        # 虚拟交换机ID
        self.vswitch_id = 'vsw-0jlufqap3ohvxd1stje8d'
        # 实例名称
        d  = datetime.datetime.now()
        dsuffix = '{0}{1}{2}{3}'.format(d.month, d.day, d.hour, d.minute)
        self.instance_name = 'ai-[0,3]-aliyun-{0}'.format(dsuffix)
        # 指定创建ECS实例的数量
        ...
        # 云服务器的主机名
        self.host_name = 'ai-[0,3]-aliyun-{0}'.format(dsuffix)
        # 是否为I/O优化实例
